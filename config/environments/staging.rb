NolaOnRails::Application.configure do
  ...
  config.action_controller.asset_host = "https://#{ENV['AWS_ASSETS_BUCKET']}-staging.s3.amazonaws.com"

  # Set the mailer host to a remote url
  config.action_mailer.asset_host = "https://#{ENV['AWS_ASSETS_BUCKET']}-staging.s3.amazonaws.com"
